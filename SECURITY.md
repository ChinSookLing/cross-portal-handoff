...
2. **`session_id` identifies a seat. It is not an authentication secret.**  
   A seat name may be public. Knowing it does not authorise a submission. Submission authority is a courier secret that is not in this repository, and must not be placed in a handoff, a public page, or a chat with a contestant.
